...
def parseEvalOutput (_instanceId : String) (evalOutput : String)
...
def msgHistoryToReport (_instanceId : String) (_msgHistory : MsgHistory)
    (_model : String) : List (String × TestStatus) :=
